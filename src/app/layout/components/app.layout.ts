        ...
        .custom-gradient-bg {
          ...
          &::before {
            ...
            background: radial-gradient(
              circle at 30% 30%,
              rgba(144, 137, 252, 0.95) 0%,
              rgba(144, 137, 252, 0.45) 20%,
              rgba(144, 137, 252, 0.12) 45%,
              rgba(144, 137, 252, 0.03) 60%,
              transparent 75%
            );
          ...
          &::after {
            ...
            background: radial-gradient(
              circle at 70% 70%,
              rgba(255, 128, 181, 0.95) 0%,
              rgba(255, 128, 181, 0.48) 18%,
              rgba(255, 128, 181, 0.08) 45%,
              transparent 65%
            );
