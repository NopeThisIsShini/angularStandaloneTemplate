...
export class PermissionComponent implements OnInit {
  ...
  private initializePermissions() {
    ...
    this.totalPermissionCount =
      this.permissionService.getAllAvailablePermissions().length;
  }
  ...
  loadPermissionsFromApiResponse(apiResponse: grantedPermissions) {
    ...
    try {
      ...
      if (this.isRoleEditing) {
        this.selectedNodes =
          this.permissionService.getSelectedRolePermissionNodes(
  ...
  savePermissions() {
    try {
      const permissions = this.permissionService.getPermissionsFromNodes(
        this.selectedNodes
      );
      if (this.isRoleEditing) {
